...
<html lang="en">
    <head>
        ...
        <title>Samgyeopsalanz</title>
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="assets-homepage/assets/img/final-logo.png" />
        ...
        <link href="assets-homepage/css/styles.css" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Masthead-->
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 my-3 my-lg-0">
                        ...
                        <a class="btn btn-dark btn-social mx-2" href="https://www.facebook.com/Samgyeopsalanz" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
